...
#
# Also this still implodes if you mix spaces and commas as delimiters.
#
# $ ./R-1.3_v1.py "10 3 5 7 1, 11 51 16"
#
# DBG: 10 3 5 7 1, 11 51 16 passed into "args.data" from command line
# DBG: As passed in, the argument "data" is type <class 'str'>
# Requires a minimum of two numbers to be supplied as input. 
#
# DBG: Variable some_list_data, created with "list(args.data) is type <class 'list'>"
# DBG: Variable some_list_data == ['10 3 5 7 1', ' 11 51 16']
#
# DBG: Data passed into "minmax()" is type <class 'list'>
# DBG: Result of "data_in.sort()" is [' 11 51 16', '10 3 5 7 1']
# DBG: Elements in list are curently type <class 'str'>
# Traceback (most recent call last):
#   File "./R-1.3_v1.py", line 95, in <module>
#       print(minmax(some_list_data))
#   File "./R-1.3_v1.py", line 87, in minmax
#       data_in = [int(x) for x in data_in]
#   File "./R-1.3_v1.py", line 87, in <listcomp>
#       data_in = [int(x) for x in data_in]
# ValueError: invalid literal for int() with base 10: ' 11 51 16'
#
...
# This really does not work as double digit numbers will count as length 2
